...
public class FakeDataHolder {
	...
	/**
	 * Recherche dans la table spécifiée un objet ayant pour valeur propertyValue à l'attribut propertyName.
	...
	/**
	 * Recherche dans la table spécifiée les objets ayant pour valeur propertyValue à l'attribut propertyName.
	 * @param tableName Le nom de la table
	 * @param propertyName Le nom de la propriété à comparer
	 * @param propertyValue La valeur de la propriété qui doit correspondre
	 * @return Retourne une liste des objets trouvés (eventuellement vide si la recherche n'a pas aboutie)
	 */
	...
	/**
	 * Recherche dans la table spécifiée les objets dont la valeur de l'attribut propertyName contient au moins propertyValue.
	 * @param tableName Le nom de la table
	 * @param propertyName Le nom de la propriété à comparer
	 * @param propertyValue La valeur de la propriété qui doit correspondre
	 * @return Retourne une liste des objets trouvés (eventuellement vide si la recherche n'a pas aboutie)
