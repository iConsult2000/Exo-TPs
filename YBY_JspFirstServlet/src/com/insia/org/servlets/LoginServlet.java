	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Cookie[] mesCookies= request.getCookies(); // Je r�cup�re tous les cookies
			if (mesCookies!=null)
			{
				...
				{
					// S'ilexisteun Cookie nomm�nomCookie"
					if (mesCookies[i].getName().equals("nomCookie"))
					{
						// J�aitrouv�le cookie queje cherchais, j�affichesavaleur:
						System.out.println(mesCookies[i].getValue());
					}
				}
			}
		
		//V�rifie si le login � �t� saisi
		if  ( (login.equals("") )&& (pass.equals("")) ){//V�rif si vide
			...
			if(login.equals("boston") && pass.equals("boston")){//V�rif si correct
				...
				response.getWriter().write("V�rifier vos mot de passe");
			}
		} 
	}
